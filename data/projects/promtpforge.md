...
| `web/interface.py` | Main Gradio interface | ~400 |
...
3. **Historique** - Browse past reformatted prompts
4. **Generer Config** - Template for AI-generated project configs
5. **Comparaison** - Model pricing comparison
6. **Aide** - Help and documentation
